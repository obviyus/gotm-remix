...
CREATE TABLE IF NOT EXISTS months (
  ...
  updated_at INTEGER DEFAULT (unixepoch()),
  UNIQUE (year, month),
  FOREIGN KEY (theme_id) REFERENCES themes (id) ON UPDATE CASCADE ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS nominations (
  ...
  FOREIGN KEY (month_id) REFERENCES months (id) ON UPDATE CASCADE ON DELETE SET NULL
);
