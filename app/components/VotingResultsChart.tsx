...
import { Chart as ChartJS, type ChartOptions, type ChartType, } from "chart.js/auto";
...
export function VotingResultsChart({
    ...
    return (
        <div
            className="rounded-xl bg-zinc-800 p-4 shadow-lg transition-shadow hover:shadow-xl sm:p-6 ring-1 ring-zinc-700">
