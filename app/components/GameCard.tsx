            ...
            <div className="flex-1 p-4 flex flex-col gap-3 overflow-hidden min-w-0">
                <div className="min-w-0 space-y-2">
                    <div className="flex justify-between items-start gap-2">
                        <h3 className="text-sm font-medium text-zinc-100 break-words bg-gradient-to-r from-zinc-100 to-zinc-300 bg-clip-text leading-snug">
                            {game.gameName}
                        </h3>
                        {year && (
                ...
                <div className="flex flex-col gap-2 mt-auto min-w-0">
                    ...
                    {onNominate && (
                        <button
                            ...
                            disabled={buttonDisabled || (alreadyNominated && isCurrentUserNomination) || isPreviousWinner}
                        ...
                        >
                            <span
                                className="relative z-10 flex items-center justify-center gap-2 transition-transform group-hover/btn:scale-105 group-disabled:transform-none">
                                {buttonText || (alreadyNominated
                                    ? isCurrentUserNomination
                                        ? "Already nominated"
                                        : "Add Pitch"
                                    : "Nominate")}
