            ...
            <nav className="border-b border-zinc-800 bg-zinc-900">
                <div className="w-full px-2 sm:px-4 lg:px-8">
                    <div className="flex h-16 justify-between md:justify-center">
                        ...
                        {/* Desktop navigation */}
                        <div
                            className="hidden md:flex md:items-center md:justify-center w-full max-w-full mx-auto overflow-x-auto">
                            <div
                                className="flex items-center justify-center flex-nowrap gap-2 sm:gap-3 md:gap-4 lg:gap-8 px-2">
                                <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                                    {navLinks
                                        ...
                                        .map((link) => (
                                            ...
                                            >
                                                <span
                                                    className="relative z-10 flex items-center justify-center gap-1 sm:gap-2 transition-transform group-hover/btn:scale-105 text-xs sm:text-sm">
                                                    {link.label}
                                                </span>
                                            </Link>
                                        ))}
                                ...
                                {centerItem && (
                                    <div className="flex items-center border-x border-zinc-800 px-2 sm:px-3 md:px-4">
                                        ...
                                        >
                                            <span
                                                className="relative z-10 flex items-center justify-center gap-1 sm:gap-2 transition-transform group-hover/btn:scale-105 text-[0.8rem] md:text-sm">
                                                {centerItem.label}
                                            </span>
                                        </Link>
                                    </div>
